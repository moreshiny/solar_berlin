    ...
    def __init__(
        ...
        Args:
            ...
            legacy_mode (bool, optional): Whether to use legacy mode or not.
                Defaults to True.
            weight_dict: a dictionary of the form {0 : a, 1 : b, 2 : c, 3 : d, 4 : e},
                where a, b, c, d, e are float32.
        """
        # initialize attributes
        if weight_dict == {}:
            self.weight_dict = {0: 1, 1: 1, 2: 1, 3: 1, 4: 1}
        else:
            assert list(weight_dict.keys()) == [
                0,
                1,
                2,
                3,
                4,
            ], "The values of the weight dictionary are not correct."
